function Footer(){
	return (
		<>
			<div className="h-48 w-full bg-black py-5 space-y-3 mt-20">
			  <p className="text-white text-center">Made with 💻</p>
			  <p className="flex items-center text-white justify-center">
			    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="inline text-white" style={{fill: "rgba(255,255,255,255)"}}>
			    ...
			    <span className="font-semibold text-lg">2021 All Rights Reserved</span>
			  </p>
			</div>
		</>
	)
